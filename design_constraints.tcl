...
# pyrite is know to have plenty of missing blocks, which should not be optimized away
if { "[get_attribute octopusRC_design_maturity_level]" == "pyrite" } { set_attribute boundary_opto false [find /des* -subdesign *] }
