# ESD netlist is used for ESD simulations with the analog modules. All digital logic is removed

if { $diehardus::analog_instances != "" } {
...
foreach avoided_analog_inst $diehardus::analog_instances {
...
::octopusRC::advanced_recursive_grouping \
	...
	--exclude-parents-of-instances $diehardus::analog_instances \
	--debug-level 2
